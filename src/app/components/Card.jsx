    ...
    <Link href={'/details'}>
      <Card className="max-w-full md:max-w-[15.313rem] lg:max-w-[20.313rem] 2xl:min-w-[29.313rem] h-auto overflow-hidden shadow-none">
        ...
        <CardBody className="p-2 md:p-6 flex items-center flex-col">
          <Typography variant="h4" color="blue-gray" className="text-xl md:text-2xl text-center font-['Squada_One']">
            TOURISTIC AREA 3 BEDROOM VILLA FOR SALE LEASEHOLD IN BALI SEMINYAK
          </Typography>
          <Typography variant="lead" color="blue-gray" className="text-base md:text-xl my-4 font-semibold text-center flex gap-1 md:gap-4 justify-center items-center">
